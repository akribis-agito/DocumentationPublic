...
The Homing process consists of steps. The maximum number of homing steps is 15 steps. The number of steps, instructions for each step and instructions’ parameters are defined by the HomingDef.

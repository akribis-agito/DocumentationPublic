...
For analog inputs, the signal path is as shown.
![Analog-input signal path from the raw electrical input through to the conditioned reading](signal-path.drawio.svg)

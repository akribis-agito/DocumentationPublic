...
> **Removed in firmware 1.3.0.1-36.** `SinCosAInPort` is no longer a supported keyword
...
1.3.0.1-36); sin/cos feedback is no longer routed through the general analog-input ports.

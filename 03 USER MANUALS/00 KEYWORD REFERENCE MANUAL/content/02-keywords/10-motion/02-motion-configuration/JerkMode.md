...
- **During homing:** `JerkMode` is forced to `0` (second-order) for the entire homing sequence, regardless of the user setting; the user value is saved on homing entry and restored when homing ends.

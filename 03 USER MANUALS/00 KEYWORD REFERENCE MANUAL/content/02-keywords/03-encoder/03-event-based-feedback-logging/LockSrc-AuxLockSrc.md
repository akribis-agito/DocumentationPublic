...
LockSrc is used to define the source of the digital event and its trigger edge.

The sign of LockSrc defines the trigger edge that activates the feedback logging. The value of 0 is a reserved option.
...
The absolute value of LockSrc determines the digital event source that triggers the feedback logging. The value definition varies according to product.

For standalone products (non-Central-i), the input sources are described as shown.
...
For Central-i products, the input sources are described as shown. Feedback logging feature is unavailable for I/O units (AGIO01 and AGIO02) and feedback unit (AGFB01).

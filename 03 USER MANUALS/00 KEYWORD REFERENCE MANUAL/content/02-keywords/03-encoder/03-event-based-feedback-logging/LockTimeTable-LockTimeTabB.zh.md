...
要将存储值转换为秒，需乘以控制周期周期时间（控制采样间隔）。在标准产品上，控制环以 16384 Hz 运行，因此每个计数为 1/16384 s ≈ 61.035 µs；在快速采样产品上，它以 65536 Hz 运行，因此每个计数为 1/65536 s ≈ 15.259 µs。例如，标准产品上存储值为 1000 对应于记录使能后 1000 × 61.035 µs ≈ 61.0 ms。

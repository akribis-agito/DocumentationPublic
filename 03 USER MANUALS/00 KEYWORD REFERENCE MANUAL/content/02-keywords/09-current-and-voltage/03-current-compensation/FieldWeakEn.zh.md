...
> **示例演算：** 指令速度远高于基速时，某测试电机在功能关闭下停在 201.9 rad/s。设置 `FieldWeakEn=1` 后，同一驱动器在相同电压限值下达到 277.3 rad/s——**提高 37%**，代价是 3 961 mA 的 d 轴电流。
>
> 提升幅度取决于电机的磁路结构。上述数值针对的是表贴式磁钢的圆形磁路电机。而凸极式内置磁钢电机（Lq/Ld ≈ 1.6）达到了 **315.7 rad/s，提高 57%**，且所需 d 轴电流*更少*——3 446 mA。凸极电机从磁场削弱中获益更大，付出的风险也更小。在为未实测的电机做估算时，37% 是保守取值。

...
> **示例演算：** 在相电感为 4 mH 的圆形磁路电机上，以 `FieldWeakKi=2.0` 启用磁场削弱后，可达速度从 201.9 rad/s 提升至 277.3 rad/s——提高 37%——d 轴电流稳定在 −3 961 mA。该稳定过程约需 15 000 个控制周期。在平均电感相同的凸极电机上，同样的增益达到 315.7 rad/s（提高 57%），且仅稳定在 −3 446 mA。

...
- **HWProtectBits / ProtectMask:** the IPM over-temperature trip is not maskable through [ProtectMask](../01-general-protection/ProtectMask.md). The separate hardware [HWProtectBits](../01-general-protection/HWProtectBits.md) IPM-fault bit (ConFlt code 1027) is one of the non-maskable protections — it stays active regardless of [ProtectMask](../01-general-protection/ProtectMask.md).

...
Position-limit braking ([FwdPLim](position-limit-protection/FwdPLim.md) / [RevPLim](position-limit-protection/RevPLim.md) and the limit switches) decelerates the axis and records the cause in [MotionReason](../../10-motion/05-motion-status/MotionReason.md) (reasons 4–7) without raising a [ConFlt](../../07-status-and-faults/ConFlt.md); the following-error / stuck / dual-stuck / stall trips disable the axis and raise ConFlt codes 1020/1055, 1021/1056, 1007, 1049, and 1065 respectively. None of the motion-protection trips is maskable through [ProtectMask](../01-general-protection/ProtectMask.md) (that mask covers hardware-protection bits only).
